...
| Method | Path                               | Auth   | Body / Query                                                                                                                                                                 | Description                                                                              |
| ------ | ---------------------------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| POST   | `/channels`                        | JWT    | Body: `{ youtubeHandle: string, parsingOptions: { ignoreEpisodesContaining: string[], ignoreEpisodesMissing: string[] }, language: string, gameCandidateAIPrompt?: string }` | Creates a channel                                                                        |
